      ...
      <BottomSheetView style={styles.contentContainer}>
        ...
        {selectedProduct && (
            <View style={styles.productCard}>
                {/* Image would go here */}
                <View>
                    <Text style={styles.productName}>{selectedProduct.productDetails.productName}</Text>
                    <Text style={styles.productDetails}>{selectedProduct.productDetails.category}</Text>
                </View>
        ...
        <Pressable style={styles.createButton} onPress={handleCreate} disabled={isPending}>
            {isPending ? <ActivityIndicator color="white" /> : <Text style={styles.createButtonText}>Create</Text>}
        </Pressable>
