  ...
  const handleCreate = () => {
    ...
    if (isNewCustomer) {
      ...
      if (selectedCustomer) {
        ...
        payload.userDetails = {
          // Curl example sends userDetails even when userExist is true?
              ...
              <View style={styles.row}>
                <View style={styles.halfInput}>
                  ...
                  <View style={styles.quantityContainer}>
                    <Pressable
                      onPress={() =>
                        setClaimQuantity((q) => Math.max(1, q - 1))
                      }
                    >
                      <Ionicons name="remove-circle" size={24} color="black" />
                    </Pressable>
                    <Text style={styles.quantityText}>
                      {claimQuantity.toString().padStart(2, "0")}
                    </Text>
                ...
                <View style={styles.halfInput}>
                  ...
                  <View style={styles.quantityContainer}>
                    ...
                    <Text style={styles.quantityText}>
                      {orderQuantity.toString().padStart(2, "0")}
                    </Text>
